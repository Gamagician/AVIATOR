...
public class Engine : AircraftAttachment 
{
	...
	public string EngineStartInputButton = "";
	...
	private void UpdateOff()
	{
		...
		if( Controllable )
		{
			...
			if ( (EngineStartInputButton!="") && Input.GetButtonDown( EngineStartInputButton ) )
			{
				EngineStart.Play();
	...
	private void UpdateStarting()
	{
		...
		if ( Controllable && (EngineStartInputButton!="") && Input.GetButton( EngineStartInputButton ) )
		{
			if ( !EngineStart.isPlaying )
			{
	...
	private void UpdateRunning()
	{
		...
		if( Controllable )
		{
			...
			if ( "" != ThrottleAxis )
			{
				float input = Input.GetAxis( ThrottleAxis );
