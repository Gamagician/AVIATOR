...
public class ControlSurfaceEditor : Editor 
{
	...
	public override void OnInspectorGUI() 
	{
		...
		if ( InputFoldOut )
		{
			targetControlSurface.AxisName = EditorGUILayout.TextField( "Axis Name", targetControlSurface.AxisName );
			targetControlSurface.Invert = EditorGUILayout.Toggle( "Invert", targetControlSurface.Invert );
		...
		//User help....
		if ( targetControlSurface.AxisName.Length == 0 )
		{
